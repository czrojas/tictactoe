...
int playerWin(int *Winner, char *Board) {
  ...
  for (int i = 0; i < 8; ++i) {
    if (results[i] == 237) { // Ascii value of 0 is 47, hence 47*3 is 144 so
                             // there are three 0s, Winnner!
      *Winner = 0;
      return 1;
    } else if (results[i] == 264) { // Ascii value of 1 is 48, hence 48*3 is 147
